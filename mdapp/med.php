...
<div class="home" <div style="width:85%; margin:0 auto;background-color:white;height:500px;padding-top:10px; box-shadow: 0px 0px 5px green;">
...
background-size:contain;height:480px; background-color:#fff;color:green;border-radius:0px;margin:0 auto;">
  <div>
    <h3>Hi Paul,</h3>
    <h2> Push the button below for Medical Attention</h2>
  </div>
...
<img src="img/heart.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/weighing.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/sugar.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
  <div class="text">75kg</div>
</div>
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/blood.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/pitcher.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
  <div class="text">---</div>
</div>
</div>Blood Water Level</div>

<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/height.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/blood1.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
  <div class="text">---</div>
</div>
...
<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/carrot.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
  <div class="text">---</div>
</div>
</div>Basic Metabolic Rate (BMR)</div>

<div style="float:left;text-align:center; font-size:13px;color:green;width:70px;height:100px;margin-top:38px;margin-left:28px;">
<div class="icon-cont" style="border:2px solid green ;border-radius:5px;position:relative;">
<img src="img/muc.png" width="64" height="64" style="margin:4px auto;display:block;">
<div class="overlay">
  <div class="text">---</div>
</div>
</div> Percentage Muscle</div>
...
<div style="margin-left:0px;margin-right:19px;float:left; font-size:12px;text-align:center;">
<a href="#" id="profile"><img width="35" hieght="35" src="img/profile.png"><br><strong>profile</strong></a>
</div>
<div style="margin-left:20px;margin-right:20px;float:left; font-size:12px;text-align:center;" >
<a href="#" id="home"><img width="35" hieght="35" src="img/action.png"><br><strong>home</strong></a>
</div>
<div style="margin-left:19px;float:left;font-size:12px;text-align:center;">
<a href="#" id="test"><img width="35" hieght="35" src="img/test.png"><br><strong>Test</strong></a>
</div>
</div>
</div>
...
<p><span> <img src="img/checked.png" width="25" height="25"><strong> Subscription Validity :</strong></span> 01/17 - 12/17(1
  Year)</p>
</div>
</div>
</div>
