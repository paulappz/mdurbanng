...
<html>
  ...
  <body>
    ...
    <div class="container" style="border: 1px solid green;border-top-right-radius:10px;border-top-left-radius:10px;">
      <div class="msg-wgt-header"style="background-color:green;border-top-right-radius:10px;border-top-left-radius:10px;">
        <a href="#">John</a>
      </div>
      <div class="msg-wgt-body" id="msg-wgt-body">
        <table id="table">
          <?php
          if (!empty($messages)) {
